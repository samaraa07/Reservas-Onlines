...
/* Botões de ação específicos (Aprovar / Reprovar / Reconsiderar) */
.btn-success {
  background: #28a745;
  color: #fff;
}
...
#### Conteúdo do arquivo `Reservas-Onlines/templates/home.html`:
```html
<!doctype html>
<html lang="pt-BR">
  <head>
  ...
  <body>
    ...
    <header class="topbar">
      ...
      <button class="topbar-btn">ENTRAR</button>
    </header>
    ...
    <section class="hero">
      ...
      <div class="hero-img">
        <img src="img/mulher-notebook.png" alt="Profissional com notebook" />
      </div>
    </section>
    ...
    <main class="cards-section">
      <div class="cards-grid">
        ...
        <article class="card-medico">
          <div class="card-foto">
            <img src="img/medico1.png" alt="Dr. Sérgio" />
          </div>
          <div class="card-conteudo">
            <h2>DR. SÉRGIO</h2>
            <h3>Endocrinologista</h3>
            <p>
              Especializado em cuidados hormonais, oferecendo atendimento
              humanizado e completo para saúde e bem-estar.
            </p>
          </div>
        </article>

        <!-- Copie/cole e troque apenas a imagem se quiser variar -->
        <article class="card-medico">
          <div class="card-foto">
            <img src="img/medica2.png" alt="Dr. Sérgio" />
          </div>
          <div class="card-conteudo">
            <h2>DR. SÉRGIO</h2>
            <h3>Endocrinologista</h3>
        ...
        <article class="card-medico">
          <div class="card-foto">
            <img src="img/medica3.png" alt="Dr. Sérgio" />
          </div>
          <div class="card-conteudo">
            <h2>DR. SÉRGIO</h2>
            <h3>Endocrinologista</h3>
        ...
        <article class="card-medico">
          <div class="card-foto">
            <img src="img/medico4.png" alt="Dr. Sérgio" />
          </div>
          <div class="card-conteudo">
            <h2>DR. SÉRGIO</h2>
            <h3>Endocrinologista</h3>
        ...
        <article class="card-medico">
          <div class="card-foto">
            <img src="img/medico5.png" alt="Dr. Sérgio" />
          </div>
          <div class="card-conteudo">
            <h2>DR. SÉRGIO</h2>
            <h3>Endocrinologista</h3>
        ...
        <article class="card-medico">
          <div class="card-foto">
            <img src="img/medica6.png" alt="Dr. Sérgio" />
          </div>
          <div class="card-conteudo">
            <h2>DR. SÉRGIO</h2>
            <h3>Endocrinologista</h3>
...
<body class="bg-light">
    ...
    <div class="container py-5">
        <!-- Título + botão de limpar -->
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="mb-0 text-dark">Painel de Usuários</h2>

            <form method="post"
                  action="{{ url_for('limpar_usuarios') }}"
                  onsubmit="return confirm('Tem certeza que deseja excluir TODOS os usuários, exceto os admins padrão? Esta ação não pode ser desfeita.');">
                <button type="submit" class="btn btn-sm btn-danger">
                    Excluir todos os usuários (exceto admins padrão)
                </button>
            </form>
        </div>
                        ...
                        <tr class="{{ u.perfil }}">
                            ...
                            <td>
                                {% if u.perfil == 'profissional' %}
                                    {{ u.profissional.status|capitalize }}
                                {% elif u.perfil == 'admin' %}
                                    {{ u.administrador.status|capitalize }}
                                {% else %}
                                    {% if u.is_ativo %}Ativo{% else %}Inativo{% endif %}
                                {% endif %}
                            </td>
                            <td>
                                {% set is_admin_padrao = u.perfil == 'admin' and u.email in [
                                ...
                                {% if is_admin_padrao %}
                                    <span class="text-muted">Admin padrão</span>

                                {% elif u.perfil == 'profissional' %}
                                    {% if u.profissional.status == 'pendente' %}
                                        <a href="{{ url_for('aprovar_profissional', user_id=u.id) }}" class="btn btn-sm btn-success">Aprovar</a>
                                        <a href="{{ url_for('reprovar_profissional', user_id=u.id) }}" class="btn btn-sm btn-danger">Reprovar</a>
                                    {% elif u.profissional.status == 'aprovado' %}
                                        <a href="{{ url_for('reprovar_profissional', user_id=u.id) }}" class="btn btn-sm btn-danger">Reprovar</a>
                                    {% elif u.profissional.status == 'reprovado' %}
                                        <a href="{{ url_for('reconsiderar_profissional', user_id=u.id) }}" class="btn btn-sm btn-warning">Reconsiderar</a>
                                    {% endif %}

                                {% elif u.perfil == 'admin' %}
                                    {% if u.administrador.status == 'pendente' %}
                                        <a href="{{ url_for('aprovar_admin', user_id=u.id) }}" class="btn btn-sm btn-success">Aprovar</a>
                                        <a href="{{ url_for('reprovar_admin', user_id=u.id) }}" class="btn btn-sm btn-danger">Reprovar</a>
                                    {% elif u.administrador.status == 'aprovado' %}
                                        <a href="{{ url_for('reprovar_admin', user_id=u.id) }}" class="btn btn-sm btn-danger">Reprovar</a>
                                    {% elif u.administrador.status == 'reprovado' %}
                                        <a href="{{ url_for('reconsiderar_admin', user_id=u.id) }}" class="btn btn-sm btn-warning">Reconsiderar</a>
                                    {% endif %}
